...
/**
 * List facet instance method
 * @param {Integer} index The starting index of the items are to be removed
 * @param {Integer} numberToRemove The number of the items to be removed
 * @return {Array[Object]} The spliced data
 */
function List$removeItems(index, numberToRemove) {
    return this.owner.data.splice(index, numberToRemove);
}
