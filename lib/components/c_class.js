...
_.extendProto(Component, {
    ...
    walkScopeTree: Component$walkScopeTree,
    getScopeTree: Component$getScopeTree,
...
function Component$getScopeTree() {
    let componentList = [this];
    if(this.container && this.container.scope) {
        for (const scopeComponent of Object.values(this.container.scope) ) {
            componentList.push(...scopeComponent.getScopeTree(scopeComponent));
        }
    }
