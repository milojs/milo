 ...
 */
var getterTemplate = fs.readFileSync(__dirname + '/templates/getter.js')
	, setterTemplate = fs.readFileSync(__dirname + '/templates/setter.js')
	, deleteTemplate = fs.readFileSync(__dirname + '/templates/delete.js')
	, spliceTemplate = fs.readFileSync(__dirname + '/templates/splice.js')
	, include_defines = fs.readFileSync(__dirname + '/templates/defines.js')
	, include_create_tree = fs.readFileSync(__dirname + '/templates/create_tree.js')
	, include_traverse_tree = fs.readFileSync(__dirname + '/templates/traverse_tree.js');
