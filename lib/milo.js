...
if (milo.config.messaging.useZeroTimeout) {
    console.info('using zeroTimeout for messaging');
    milo.Messenger.useSetTimeout(milo.util.zeroTimeout);
}


if (milo.config.defer.useZeroTimeout) {
    console.info('using zeroTimeout for defers');
    _.useSetTimeout(milo.util.zeroTimeout);
}
